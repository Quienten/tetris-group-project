 ...
 * @version 1.3
 */
public final class MovableTetrisPiece implements MovablePiece {
     ...
     * 
     * @param theTetrisPoint the point to transform the points around.
     * @return array of TetrisPiece block points.
     */
    private Point[] getPoints(final Point theTetrisPoint) {
        ...
        for (int i = 0; i < blocks.length; i++) {
            ...
            if (theTetrisPoint != null) {
                blocks[i] = blocks[i].transform(theTetrisPoint);
            }
        }
